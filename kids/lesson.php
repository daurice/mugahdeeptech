...
<article class="animated-lesson">
  ...
  <?php require_once __DIR__.'/../includes/academy-lesson-blocks.php'; render_managed_lesson_content($pdo,'Kids',(int)$lesson['id']); ?><section class="learning-steps"><div class="section-heading centered"><div><span class="kids-kicker">Let’s break it down</span><h2>Three bright ideas</h2></div></div><div class="step-grid">
